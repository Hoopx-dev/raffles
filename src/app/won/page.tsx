...
import { useTicketList, UserTicket } from '@/lib/hooks/useTickets';
...
export default function WonPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#FFF5F5] to-[#FFE8E8] flex items-center justify-center">
  ...
  if (!primaryTicket) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#FFF5F5] to-[#FFE8E8] flex flex-col items-center justify-center p-4">
        <p className="text-gray-600 text-center mb-4">No winning tickets found</p>
        <button
          onClick={() => router.push('/')}
          className="px-6 py-2 bg-primary text-white rounded-full font-medium cursor-pointer"
        >
          Go Home
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#FFF5F5] to-[#FFE8E8]">
      <div className="max-w-md mx-auto px-4 py-8">
        {/* Header */}
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-[#91000A] flex items-center justify-center gap-2">
            <span>❄️</span>
            <span>🎄</span>
            <span>⭐</span>
          ...
          <p className="text-[#91000A] mt-1">HoopXmas Raffle Ticket Winner</p>
        </div>
        ...
        {/* Your Winning Ticket */}
        <div className="bg-white rounded-2xl p-4 shadow-sm mb-4 border-2 border-[#D4A942]">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-4 mb-3">
            ...
            <a href="https://t.me" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-800">
          ...
          <p className="text-[#91000A] text-xs mt-1">
